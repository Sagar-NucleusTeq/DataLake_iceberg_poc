{% docs gold_policy_parties %}
{% raw %}

# Policy-Party Role Table
![last updated](assets/update_badges/gold_policy_parties.svg)
...
This table does not contain records that were entered in error and consequently not considered active.
...
4. Level Term and Universal Life products don't have beneficiaries in LSP, they exist only on
the actual application in [lifenotes](#!/exposure/docs.business_glossary.glossary#lifenotes).
