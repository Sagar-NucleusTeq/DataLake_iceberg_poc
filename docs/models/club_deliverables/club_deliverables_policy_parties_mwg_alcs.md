...
{% docs club_deliverables_policy_parties_mwg_alcs %}
{% raw %}

# Policy Parties MWG (ALCS) - Club Deliverable

![last updated](assets/update_badges/club_deliverables_policy_parties_mwg_alcs.svg)

A [reporting layer table](#!/exposure/docs.business_glossary.glossary#reporting_layer)
for parties related to applications and policies that have the club code of MWG (ALCS) showing all 
