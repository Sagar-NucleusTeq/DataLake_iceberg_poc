...
{% docs club_deliverables_policy_parties_034_aaa_kansas %}
{% raw %}

# Policy Parties 034 - AAA Kansas - Club Deliverable

![last updated](assets/update_badges/club_deliverables_policy_parties_034_aaa_kansas.svg)

A [reporting layer table](#!/exposure/docs.business_glossary.glossary#reporting_layer)
for parties related to applications and policies that have the club code of 034 - AAA Kansas showing all 
