...
{% docs club_deliverables_policy_parties_195_aaa_central_penn_auto_club %}
{% raw %}

# Policy Parties 195 - AAA Central Penn Auto Club - Club Deliverable

![last updated](assets/update_badges/club_deliverables_policy_parties_195_aaa_central_penn_auto_club.svg)

A [reporting layer table](#!/exposure/docs.business_glossary.glossary#reporting_layer)
for parties related to applications and policies that have the club code of 195 - AAA Central Penn Auto Club showing all 
