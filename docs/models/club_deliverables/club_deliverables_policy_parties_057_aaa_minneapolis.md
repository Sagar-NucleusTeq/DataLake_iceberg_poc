...
{% docs club_deliverables_policy_parties_057_aaa_minneapolis %}
{% raw %}

# Policy Parties 057 - AAA Minneapolis - Club Deliverable

![last updated](assets/update_badges/club_deliverables_policy_parties_057_aaa_minneapolis.svg)

A [reporting layer table](#!/exposure/docs.business_glossary.glossary#reporting_layer)
for parties related to applications and policies that have the club code of 057 - AAA Minneapolis showing all 
