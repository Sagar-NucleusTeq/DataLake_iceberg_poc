...
{% docs club_deliverables_policy_parties_219_aaa_reading_berks %}
{% raw %}

# Policy Parties 219 - AAA Reading-Berks - Club Deliverable

![last updated](assets/update_badges/club_deliverables_policy_parties_219_aaa_reading_berks.svg)

A [reporting layer table](#!/exposure/docs.business_glossary.glossary#reporting_layer)
for parties related to applications and policies that have the club code of 219 - AAA Reading-Berks showing all 
