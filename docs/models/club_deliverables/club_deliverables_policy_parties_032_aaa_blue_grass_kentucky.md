...
{% docs club_deliverables_policy_parties_032_aaa_blue_grass_kentucky %}
{% raw %}

# Policy Parties 032 - AAA Blue Grass/Kentucky - Club Deliverable

![last updated](assets/update_badges/club_deliverables_policy_parties_032_aaa_blue_grass_kentucky.svg)

A [reporting layer table](#!/exposure/docs.business_glossary.glossary#reporting_layer)
for parties related to applications and policies that have the club code of 032 - AAA Blue Grass/Kentucky showing all 
