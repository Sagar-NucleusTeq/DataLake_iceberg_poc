...
{% docs club_deliverables_policy_parties_ace_alsc %}
{% raw %}

# Policy Parties ACE (ALSC) - Club Deliverable

![last updated](assets/update_badges/club_deliverables_policy_parties_ace_alsc.svg)

A [reporting layer table](#!/exposure/docs.business_glossary.glossary#reporting_layer)
for parties related to applications and policies that have the club code of ACE (ALSC) showing all 
