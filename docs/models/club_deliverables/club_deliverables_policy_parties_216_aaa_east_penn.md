...
{% docs club_deliverables_policy_parties_216_aaa_east_penn %}
{% raw %}

# Policy Parties 216 - AAA East Penn - Club Deliverable

![last updated](assets/update_badges/club_deliverables_policy_parties_216_aaa_east_penn.svg)

A [reporting layer table](#!/exposure/docs.business_glossary.glossary#reporting_layer)
for parties related to applications and policies that have the club code of 216 - AAA East Penn showing all 
