...
{% docs club_deliverables_policy_parties_130_aaa_ohio_auto_club %}
{% raw %}

# Policy Parties 130 - AAA Ohio Auto Club - Club Deliverable

![last updated](assets/update_badges/club_deliverables_policy_parties_130_aaa_ohio_auto_club.svg)

A [reporting layer table](#!/exposure/docs.business_glossary.glossary#reporting_layer)
for parties related to applications and policies that have the club code of 130 - AAA Ohio Auto Club showing all 
