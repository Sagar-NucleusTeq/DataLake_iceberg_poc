...
{% docs club_deliverables_policy_parties_084_western_and_central_new_york %}
{% raw %}

# Policy Parties 084 - Western and Central New York - Club Deliverable

![last updated](assets/update_badges/club_deliverables_policy_parties_084_western_and_central_new_york.svg)

A [reporting layer table](#!/exposure/docs.business_glossary.glossary#reporting_layer)
for parties related to applications and policies that have the club code of 084 - Western and Central New York showing all 
