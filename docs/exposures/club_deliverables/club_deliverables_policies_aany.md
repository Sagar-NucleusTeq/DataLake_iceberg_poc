...
{% docs club_deliverables_exposure_policies_aany %}
{% raw %}

# Policies for AANY - Club Deliverable
...
file that is supported by redshift. This exposure is provided to AANY and contains
policy information for the following clubs: ['097'].
...
Today's folder location: /AANY/policy/V1/YYYY/MM/DD/policies_AANY.parquet
...
| Filters:                 | AANY only - filtering done before sent to AANY |
