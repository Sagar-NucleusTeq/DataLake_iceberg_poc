...
{% docs club_deliverables_exposure_policies_212_aaa_mid_atlantic %}
{% raw %}

# Policies for 212 - AAA Mid-Atlantic - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 212 - AAA Mid-Atlantic and contains
policy information for the following clubs: ['078', '212'].
...
Today's folder location: /212 - AAA Mid-Atlantic/policy/V1/YYYY/MM/DD/policies_212 - AAA Mid-Atlantic.parquet
...
| Filters:                 | 212 - AAA Mid-Atlantic only - filtering done before sent to 212 - AAA Mid-Atlantic |
