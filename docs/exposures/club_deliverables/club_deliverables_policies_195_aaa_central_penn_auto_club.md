...
{% docs club_deliverables_exposure_policies_195_aaa_central_penn_auto_club %}
{% raw %}

# Policies for 195 - AAA Central Penn Auto Club - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 195 - AAA Central Penn Auto Club and contains
policy information for the following clubs: ['195', '201'].
...
Today's folder location: /195 - AAA Central Penn Auto Club/policy/V1/YYYY/MM/DD/policies_195 - AAA Central Penn Auto Club.parquet
...
| Filters:                 | 195 - AAA Central Penn Auto Club only - filtering done before sent to 195 - AAA Central Penn Auto Club |
