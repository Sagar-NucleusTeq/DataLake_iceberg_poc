...
{% docs club_deliverables_exposure_policies_263_aaa_southern_west_virginia %}
{% raw %}

# Policies for 263 - AAA Southern West Virginia - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 263 - AAA Southern West Virginia and contains
policy information for the following clubs: ['263'].
...
Today's folder location: /263 - AAA Southern West Virginia/policy/V1/YYYY/MM/DD/policies_263 - AAA Southern West Virginia.parquet
...
| Filters:                 | 263 - AAA Southern West Virginia only - filtering done before sent to 263 - AAA Southern West Virginia |
