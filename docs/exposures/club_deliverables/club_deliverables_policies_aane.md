...
{% docs club_deliverables_exposure_policies_aane %}
{% raw %}

# Policies for AANE - Club Deliverable
...
file that is supported by redshift. This exposure is provided to AANE and contains
policy information for the following clubs: ['008', '042', '044', '045', '074', '075', '097', '240'].
...
Today's folder location: /AANE/policy/V1/YYYY/MM/DD/policies_AANE.parquet
...
| Filters:                 | AANE only - filtering done before sent to AANE |
