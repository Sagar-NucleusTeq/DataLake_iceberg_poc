...
{% docs club_deliverables_exposure_policies_080_aaa_hudson_valley %}
{% raw %}

# Policies for 080 - AAA Hudson Valley - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 080 - AAA Hudson Valley and contains
policy information for the following clubs: ['080'].
...
Today's folder location: /080 - AAA Hudson Valley/policy/V1/YYYY/MM/DD/policies_080 - AAA Hudson Valley.parquet
...
| Filters:                 | 080 - AAA Hudson Valley only - filtering done before sent to 080 - AAA Hudson Valley |
