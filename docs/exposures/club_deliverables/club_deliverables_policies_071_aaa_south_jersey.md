...
{% docs club_deliverables_exposure_policies_071_aaa_south_jersey %}
{% raw %}

# Policies for 071 - AAA South Jersey - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 071 - AAA South Jersey and contains
policy information for the following clubs: ['071'].
...
Today's folder location: /071 - AAA South Jersey/policy/V1/YYYY/MM/DD/policies_071 - AAA South Jersey.parquet
...
| Filters:                 | 071 - AAA South Jersey only - filtering done before sent to 071 - AAA South Jersey |
