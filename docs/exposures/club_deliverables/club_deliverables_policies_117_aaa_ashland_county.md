...
{% docs club_deliverables_exposure_policies_117_aaa_ashland_county %}
{% raw %}

# Policies for 117 - AAA Ashland County - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 117 - AAA Ashland County and contains
policy information for the following clubs: ['117'].
...
Today's folder location: /117 - AAA Ashland County/policy/V1/YYYY/MM/DD/policies_117 - AAA Ashland County.parquet
...
| Filters:                 | 117 - AAA Ashland County only - filtering done before sent to 117 - AAA Ashland County |
