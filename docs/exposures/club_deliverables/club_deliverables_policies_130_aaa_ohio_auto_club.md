...
{% docs club_deliverables_exposure_policies_130_aaa_ohio_auto_club %}
{% raw %}

# Policies for 130 - AAA Ohio Auto Club - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 130 - AAA Ohio Auto Club and contains
policy information for the following clubs: ['115', '119', '130', '147'].
...
Today's folder location: /130 - AAA Ohio Auto Club/policy/V1/YYYY/MM/DD/policies_130 - AAA Ohio Auto Club.parquet
...
| Filters:                 | 130 - AAA Ohio Auto Club only - filtering done before sent to 130 - AAA Ohio Auto Club |
