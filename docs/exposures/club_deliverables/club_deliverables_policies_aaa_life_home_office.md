...
{% docs club_deliverables_exposure_policies_aaa_life_home_office %}
{% raw %}

# Policies for AAA Life Home Office - Club Deliverable
...
file that is supported by redshift. This exposure is provided to AAA Life Home Office and contains
policy information for the following clubs: ['961'].
...
Today's folder location: /AAA Life Home Office/policy/V1/YYYY/MM/DD/policies_AAA Life Home Office.parquet
...
| Filters:                 | AAA Life Home Office only - filtering done before sent to AAA Life Home Office |
