...
{% docs club_deliverables_exposure_policies_241_aaa_south_dakota %}
{% raw %}

# Policies for 241 - AAA South Dakota - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 241 - AAA South Dakota and contains
policy information for the following clubs: ['241'].
...
Today's folder location: /241 - AAA South Dakota/policy/V1/YYYY/MM/DD/policies_241 - AAA South Dakota.parquet
...
| Filters:                 | 241 - AAA South Dakota only - filtering done before sent to 241 - AAA South Dakota |
