...
{% docs club_deliverables_exposure_policies_177_aaa_oregon_idaho %}
{% raw %}

# Policies for 177 - AAA Oregon/Idaho - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 177 - AAA Oregon/Idaho and contains
policy information for the following clubs: ['177'].
...
Today's folder location: /177 - AAA Oregon/Idaho/policy/V1/YYYY/MM/DD/policies_177 - AAA Oregon/Idaho.parquet
...
| Filters:                 | 177 - AAA Oregon/Idaho only - filtering done before sent to 177 - AAA Oregon/Idaho |
