...
{% docs club_deliverables_exposure_policies_aaa_home %}
{% raw %}

# Policies for AAA HOME - Club Deliverable
...
policy information for the following clubs: ['000'].
...
Today's folder location: /AAA HOME/policy/V1/YYYY/MM/DD/policies_AAA HOME.parquet
