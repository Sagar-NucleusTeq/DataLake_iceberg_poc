...
{% docs club_deliverables_exposure_policies_034_aaa_kansas %}
{% raw %}

# Policies for 034 - AAA Kansas - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 034 - AAA Kansas and contains
policy information for the following clubs: ['034'].
...
Today's folder location: /034 - AAA Kansas/policy/V1/YYYY/MM/DD/policies_034 - AAA Kansas.parquet
...
| Filters:                 | 034 - AAA Kansas only - filtering done before sent to 034 - AAA Kansas |
