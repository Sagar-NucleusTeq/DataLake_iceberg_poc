...
{% docs club_deliverables_exposure_policies_006_aaa_colorado %}
{% raw %}

# Policies for 006 - AAA Colorado - Club Deliverable
...
policy information for the following clubs: ['006'].
...
Today's folder location: /006 - AAA Colorado/policy/V1/YYYY/MM/DD/policies_006 - AAA Colorado.parquet
