...
{% docs club_deliverables_exposure_policy_parties_057_aaa_minneapolis %}
{% raw %}

# Policy Parties for 057 - AAA Minneapolis - Club Deliverable
...
Today's folder location: /057 - AAA Minneapolis/policy_party/V1/YYYY/MM/DD/policy_parties_057 - AAA Minneapolis.parquet
