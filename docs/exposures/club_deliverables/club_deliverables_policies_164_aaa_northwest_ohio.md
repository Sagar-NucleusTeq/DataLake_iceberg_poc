...
{% docs club_deliverables_exposure_policies_164_aaa_northwest_ohio %}
{% raw %}

# Policies for 164 - AAA Northwest Ohio - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 164 - AAA Northwest Ohio and contains
policy information for the following clubs: ['164'].
...
Today's folder location: /164 - AAA Northwest Ohio/policy/V1/YYYY/MM/DD/policies_164 - AAA Northwest Ohio.parquet
...
| Filters:                 | 164 - AAA Northwest Ohio only - filtering done before sent to 164 - AAA Northwest Ohio |
