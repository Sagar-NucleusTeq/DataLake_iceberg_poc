...
{% docs club_deliverables_exposure_policy_parties_aany %}
{% raw %}

# Policy Parties for AANY - Club Deliverable
...
Today's folder location: /AANY/policy_party/V1/YYYY/MM/DD/policy_parties_AANY.parquet
