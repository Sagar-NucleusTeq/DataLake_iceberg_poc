...
{% docs club_deliverables_exposure_policies_007_aaa_allied_group %}
{% raw %}

# Policies for 007 - AAA Allied Group - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 007 - AAA Allied Group and contains
policy information for the following clubs: ['007', '133'].
...
Today's folder location: /007 - AAA Allied Group/policy/V1/YYYY/MM/DD/policies_007 - AAA Allied Group.parquet
...
| Filters:                 | 007 - AAA Allied Group only - filtering done before sent to 007 - AAA Allied Group |
