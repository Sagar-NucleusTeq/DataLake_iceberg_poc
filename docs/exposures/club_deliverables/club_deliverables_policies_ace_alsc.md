...
{% docs club_deliverables_exposure_policies_ace_alsc %}
{% raw %}

# Policies for ACE (ALSC) - Club Deliverable
...
file that is supported by redshift. This exposure is provided to ACE (ALSC) and contains
policy information for the following clubs: ['001', '004', '018', '022', '036', '065', '116', '128', '158', '189', '215', '252', '257', '258', '269', '601'].
...
Today's folder location: /ACE (ALSC)/policy/V1/YYYY/MM/DD/policies_ACE (ALSC).parquet
...
| Filters:                 | ACE (ALSC) only - filtering done before sent to ACE (ALSC) |
