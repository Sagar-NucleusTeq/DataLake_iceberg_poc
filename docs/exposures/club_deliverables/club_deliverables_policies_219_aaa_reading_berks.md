...
{% docs club_deliverables_exposure_policies_219_aaa_reading_berks %}
{% raw %}

# Policies for 219 - AAA Reading-Berks - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 219 - AAA Reading-Berks and contains
policy information for the following clubs: ['219'].
...
Today's folder location: /219 - AAA Reading-Berks/policy/V1/YYYY/MM/DD/policies_219 - AAA Reading-Berks.parquet
...
| Filters:                 | 219 - AAA Reading-Berks only - filtering done before sent to 219 - AAA Reading-Berks |
