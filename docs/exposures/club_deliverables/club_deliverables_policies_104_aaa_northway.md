...
{% docs club_deliverables_exposure_policies_104_aaa_northway %}
{% raw %}

# Policies for 104 - AAA Northway - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 104 - AAA Northway and contains
policy information for the following clubs: ['083', '104'].
...
Today's folder location: /104 - AAA Northway/policy/V1/YYYY/MM/DD/policies_104 - AAA Northway.parquet
...
| Filters:                 | 104 - AAA Northway only - filtering done before sent to 104 - AAA Northway |
