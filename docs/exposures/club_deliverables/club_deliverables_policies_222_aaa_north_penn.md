...
{% docs club_deliverables_exposure_policies_222_aaa_north_penn %}
{% raw %}

# Policies for 222 - AAA North Penn - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 222 - AAA North Penn and contains
policy information for the following clubs: ['222'].
...
Today's folder location: /222 - AAA North Penn/policy/V1/YYYY/MM/DD/policies_222 - AAA North Penn.parquet
...
| Filters:                 | 222 - AAA North Penn only - filtering done before sent to 222 - AAA North Penn |
