...
{% docs club_deliverables_exposure_policies_188_aaa_northampton_county %}
{% raw %}

# Policies for 188 - AAA Northampton County - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 188 - AAA Northampton County and contains
policy information for the following clubs: ['188', '217'].
...
Today's folder location: /188 - AAA Northampton County/policy/V1/YYYY/MM/DD/policies_188 - AAA Northampton County.parquet
...
| Filters:                 | 188 - AAA Northampton County only - filtering done before sent to 188 - AAA Northampton County |
