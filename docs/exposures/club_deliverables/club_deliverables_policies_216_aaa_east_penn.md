...
{% docs club_deliverables_exposure_policies_216_aaa_east_penn %}
{% raw %}

# Policies for 216 - AAA East Penn - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 216 - AAA East Penn and contains
policy information for the following clubs: ['178', '216'].
...
Today's folder location: /216 - AAA East Penn/policy/V1/YYYY/MM/DD/policies_216 - AAA East Penn.parquet
...
| Filters:                 | 216 - AAA East Penn only - filtering done before sent to 216 - AAA East Penn |
