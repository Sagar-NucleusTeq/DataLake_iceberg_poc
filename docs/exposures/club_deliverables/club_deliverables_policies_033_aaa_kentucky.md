...
{% docs club_deliverables_exposure_policies_033_aaa_kentucky %}
{% raw %}

# Policies for 033 - AAA Kentucky - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 033 - AAA Kentucky and contains
policy information for the following clubs: ['033'].
...
Today's folder location: /033 - AAA Kentucky/policy/V1/YYYY/MM/DD/policies_033 - AAA Kentucky.parquet
...
| Filters:                 | 033 - AAA Kentucky only - filtering done before sent to 033 - AAA Kentucky |
