...
{% docs club_deliverables_exposure_policies_137_findlay_automobile_club %}
{% raw %}

# Policies for 137 - Findlay Automobile Club - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 137 - Findlay Automobile Club and contains
policy information for the following clubs: ['137'].
...
Today's folder location: /137 - Findlay Automobile Club/policy/V1/YYYY/MM/DD/policies_137 - Findlay Automobile Club.parquet
...
| Filters:                 | 137 - Findlay Automobile Club only - filtering done before sent to 137 - Findlay Automobile Club |
