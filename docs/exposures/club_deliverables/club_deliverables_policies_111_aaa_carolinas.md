...
{% docs club_deliverables_exposure_policies_111_aaa_carolinas %}
{% raw %}

# Policies for 111 - AAA Carolinas - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 111 - AAA Carolinas and contains
policy information for the following clubs: ['111', '112'].
...
Today's folder location: /111 - AAA Carolinas/policy/V1/YYYY/MM/DD/policies_111 - AAA Carolinas.parquet
...
| Filters:                 | 111 - AAA Carolinas only - filtering done before sent to 111 - AAA Carolinas |
