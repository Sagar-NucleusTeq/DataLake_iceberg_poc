...
{% docs club_deliverables_exposure_policies_032_aaa_blue_grass_kentucky %}
{% raw %}

# Policies for 032 - AAA Blue Grass/Kentucky - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 032 - AAA Blue Grass/Kentucky and contains
policy information for the following clubs: ['032'].
...
Today's folder location: /032 - AAA Blue Grass/Kentucky/policy/V1/YYYY/MM/DD/policies_032 - AAA Blue Grass/Kentucky.parquet
...
| Filters:                 | 032 - AAA Blue Grass/Kentucky only - filtering done before sent to 032 - AAA Blue Grass/Kentucky |
