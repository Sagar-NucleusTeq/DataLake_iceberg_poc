...
{% docs club_deliverables_exposure_policies_238_aaa_southern_pennsylvania %}
{% raw %}

# Policies for 238 - AAA Southern Pennsylvania - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 238 - AAA Southern Pennsylvania and contains
policy information for the following clubs: ['238'].
...
Today's folder location: /238 - AAA Southern Pennsylvania/policy/V1/YYYY/MM/DD/policies_238 - AAA Southern Pennsylvania.parquet
...
| Filters:                 | 238 - AAA Southern Pennsylvania only - filtering done before sent to 238 - AAA Southern Pennsylvania |
