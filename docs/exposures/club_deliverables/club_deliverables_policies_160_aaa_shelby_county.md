...
{% docs club_deliverables_exposure_policies_160_aaa_shelby_county %}
{% raw %}

# Policies for 160 - AAA Shelby County - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 160 - AAA Shelby County and contains
policy information for the following clubs: ['160'].
...
Today's folder location: /160 - AAA Shelby County/policy/V1/YYYY/MM/DD/policies_160 - AAA Shelby County.parquet
...
| Filters:                 | 160 - AAA Shelby County only - filtering done before sent to 160 - AAA Shelby County |
