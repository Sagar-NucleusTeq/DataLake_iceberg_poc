...
{% docs club_deliverables_exposure_policy_parties_033_aaa_kentucky %}
{% raw %}

# Policy Parties for 033 - AAA Kentucky - Club Deliverable
...
Today's folder location: /033 - AAA Kentucky/policy_party/V1/YYYY/MM/DD/policy_parties_033 - AAA Kentucky.parquet
