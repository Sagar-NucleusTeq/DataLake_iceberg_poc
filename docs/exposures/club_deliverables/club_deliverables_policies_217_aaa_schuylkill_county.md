...
{% docs club_deliverables_exposure_policies_217_aaa_schuylkill_county %}
{% raw %}

# Policies for 217 - AAA Schuylkill County - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 217 - AAA Schuylkill County and contains
policy information for the following clubs: ['217'].
...
Today's folder location: /217 - AAA Schuylkill County/policy/V1/YYYY/MM/DD/policies_217 - AAA Schuylkill County.parquet
...
| Filters:                 | 217 - AAA Schuylkill County only - filtering done before sent to 217 - AAA Schuylkill County |
