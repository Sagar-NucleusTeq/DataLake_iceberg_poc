...
{% docs club_deliverables_exposure_policy_parties_mwg_alcs %}
{% raw %}

# Policy Parties for MWG (ALCS) - Club Deliverable
...
Today's folder location: /MWG (ALCS)/policy_party/V1/YYYY/MM/DD/policy_parties_MWG (ALCS).parquet
