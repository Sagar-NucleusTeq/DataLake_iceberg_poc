...
{% docs club_deliverables_exposure_policies_127_aaa_cincinnati %}
{% raw %}

# Policies for 127 - AAA Cincinnati - Club Deliverable
...
file that is supported by redshift. This exposure is provided to 127 - AAA Cincinnati and contains
policy information for the following clubs: ['127'].
...
Today's folder location: /127 - AAA Cincinnati/policy/V1/YYYY/MM/DD/policies_127 - AAA Cincinnati.parquet
...
| Filters:                 | 127 - AAA Cincinnati only - filtering done before sent to 127 - AAA Cincinnati |
