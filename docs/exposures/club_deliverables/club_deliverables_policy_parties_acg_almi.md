...
{% docs club_deliverables_exposure_policy_parties_acg_almi %}
{% raw %}

# Policy Parties for ACG (ALMI) - Club Deliverable
...
['006', '012', '014', '020', '047', '049', '069', '113', '242', '243', '270']"
...
Today's folder location: /ACG (ALMI)/policy_party/V1/YYYY/MM/DD/policy_parties_ACG (ALMI).parquet
